...
import { AddCurriculumModal } from "@/components/curriculum/add-curriculum-modal"
    ...
    <DashboardLayout>
      <div className="flex flex-col gap-4 w-full p-4">
        <div className="flex justify-between items-center">
          ...
          <AddCurriculumModal onCurriculumAdded={fetchSubjects} />
        </div>

        {subjects.length === 0 ? (
          <div className="text-center py-10">
            <p className="text-muted-foreground">No curriculum found. Add your first curriculum to get started.</p>
          </div>
        ) : (
            ...
            {subjects.map((subject) => (
              <Card key={subject.subject_id} className="flex flex-col">
                ...
                <CardFooter className="flex justify-between mt-auto">
                  <EditCurriculumModal subject={subject} onCurriculumUpdated={fetchSubjects} />
